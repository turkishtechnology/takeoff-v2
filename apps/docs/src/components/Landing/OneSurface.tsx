...
const CODE_THEME: PrismTheme = {
  ...
  styles: [
    ...
    { types: ['keyword', 'operator'], style: { color: 'var(--runway-syntax-keyword)' } },
    { types: ['string', 'attr-value'], style: { color: 'var(--runway-syntax-string)' } },
    { types: ['function', 'class-name'], style: { color: 'var(--runway-syntax-function)' } },
    { types: ['tag'], style: { color: 'var(--runway-syntax-tag)' } },
