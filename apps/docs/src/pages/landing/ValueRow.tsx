...
import { BrushIconOutlinedRounded } from '@takeoff-icons/react/brush';
import { GroupIconOutlinedRounded } from '@takeoff-icons/react/group';
import { SparklesIconOutlinedRounded } from '@takeoff-icons/react/sparkles';
...
const CARDS: ValueCard[] = [
  ...
  },
  {
    ...
    icon: <ArrowCodeIconOutlinedRounded />,
  },
  {
    index: '03',
    label: 'Accessibility',
  ...
  },
  {
    ...
    icon: (
      <svg className={styles.inlineIcon} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
  ...
  },
  {
    ...
    icon: <SparklesIconOutlinedRounded />,
  },
];
