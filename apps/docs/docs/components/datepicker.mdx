...
const format = v => (v ? String(v.getDate()).padStart(2, '0') + '/' + String(v.getMonth() + 1).padStart(2, '0') + '/' + v.getFullYear() : '');
    ...
    <div className="mx-auto w-72">
      <Field>
        ...
        <Popover open={open} onOpenChange={toggle}>
          ...
          <Popover.Content align="end" classNames={{ root: 'tk-datepicker-panel' }}>
            <Calendar value={draft} month={month} onMonthChange={setMonth} onValueChange={setDraft} />
...
the panel's own button promote the draft to the value the field shows.
