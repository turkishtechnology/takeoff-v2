...
| Name                                 | Type                                           | Default | Description                                                                                                                                                                                                                                                                        |
| ------------------------------------ | ---------------------------------------------- | ------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <ApiBadge label="onEscapeKeyDown" /> | <code>(event: KeyboardEvent) =&gt; void</code> | -       | Called when Escape is pressed while the tooltip is open — with focus on the trigger (the usual case), inside the content, or anywhere else in the document. Runs before the internal close with the native keyboard event; call `preventDefault()` on it to keep the tooltip open. |
