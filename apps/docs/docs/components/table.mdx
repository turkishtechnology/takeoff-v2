...
export const stickyDemo = String.raw`
function StickyDemo() {
  const data = [
  ...
  const columns = [
    { id: 'name',    header: 'Name',       accessor: 'name',    sticky: 'left',  sortable: true, minWidth: 180 },
    { id: 'dept',    header: 'Department', accessor: 'dept',    sortable: true,  minWidth: 140,
      filter: { type: 'checkbox', options: [
        { label: 'Engineering', value: 'Engineering' },
        { label: 'Research', value: 'Research' },
      ]},
    },
    { id: 'role',    header: 'Role',       accessor: 'role',    minWidth: 100,
    ...
    { id: 'city',    header: 'City',       accessor: 'city',    minWidth: 130 },
    { id: 'country', header: 'Country',    accessor: 'country', minWidth: 100, align: 'center' },
    { id: 'age',     header: 'Age',        accessor: 'age',     minWidth: 80,  align: 'end', sortable: true },
    { id: 'salary',  header: 'Salary',     accessor: 'salary',  minWidth: 110, align: 'end', sortable: true,
    ...
    { id: 'actions', header: '', align: 'end', sticky: 'right', minWidth: 80,
      cell: ({ row }) => (
        <Button size="small" appearance="text" onClick={() => alert('Edit ' + row.original.name)}>
          Edit
        </Button>
...
| <span id="table-td-tableslot"><ApiBadge label="TableSlot" /></span>                         | <code>&#124; 'root' &#124; 'tableViewport' &#124; 'table' &#124; 'header' &#124; 'headerRow' &#124; 'headerCell' &#124; 'headerContent' &#124; 'sortTrigger' &#124; 'sortIcon' &#124; 'body' &#124; 'row' &#124; 'cell' &#124; 'selectionCell' &#124; 'expandCell' &#124; 'expandButton' &#124; 'expandedRow' &#124; 'filterPanel' &#124; 'pagination' &#124; 'empty' &#124; 'loading'</code> |
