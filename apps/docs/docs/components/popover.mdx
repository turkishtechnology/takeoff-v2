...
keep `Popover.Arrow` a direct child of `Popover.Content`. Applying `overflow`
to `Popover.Content` itself would clip the arrow, because the arrow is
positioned just outside the content box.
...
| -------------------------------- | ---------------------------------- | ------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <ApiBadge label="children" />    | <code>React.React.ReactNode</code> | -       | PopoverTrigger and PopoverContent components                                                                                                                     |
