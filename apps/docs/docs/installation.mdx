...
Copilot, Cursor, and Claude don't know this library and will invent props unless
you tell them about it. Copying one file into your repository root fixes that:
