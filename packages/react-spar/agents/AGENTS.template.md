...
For React applications moving from `@takeoff-ui/react` and `Tk*` components, use
the repository's `migrate-takeoff-v1` skill. It provides the inventory scanner,
setup order, v1-to-v2 component map, event/prop guidance, and known coverage
gaps. The full skill is available in the v2 repository under
